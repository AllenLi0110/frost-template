...
check_phase_eight_docs() {
  ...
  check_required_text frontend/app/page.tsx "refreshAllVaultBalances"
  check_required_text frontend/app/page.tsx "refreshWalletBalanceSnapshot"
  check_required_text frontend/app/page.tsx "Vault balances refreshed"
  ...
  check_required_text features/wallet-derivation.feature "Refresh all visible vault balances"
  check_required_text features/signing-transfer.feature "Vault Watch should refresh the latest wallet balances"
  check_required_text docs/contracts/crypto-dashboard-ux.md "Phase 8 changes the reviewer-facing presentation only."
  check_required_text docs/contracts/crypto-dashboard-ux.md "The Vault Watch refresh control must refresh every visible vault through the balance lookup API"
